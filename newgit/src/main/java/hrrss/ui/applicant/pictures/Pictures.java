package hrrss.ui.applicant.pictures;
...
public class Pictures extends BasePage {
    ...
    public Pictures() {
    	...
    	add(new Label("editAll",editAll).setEscapeModelStrings(false));
    	String applicantLink="<a href=\"/applicant/pictures/\">Edit your profile picture</a><br>";
    	...
    	form.add(new Button("submit") {
    		...
    		if(uploadedFile != null) {
    			...
    			try {
    				...
    				throw new RedirectToUrlException("/applicant/pictures/");
